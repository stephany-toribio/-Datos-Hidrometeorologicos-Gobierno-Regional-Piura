...
st.markdown('''Al norte del país se encuentra instalado el Proyecto Especial Chira Piura, que se encarga de la administración de los recursos hídricos 
	...
	>n- **Base de Datos:** (https://www.datosabiertos.gob.pe/node/10105/download)''')
